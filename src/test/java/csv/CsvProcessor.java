...
public class CsvProcessor {
    ...
    private static void readWithCsvMapReader() throws Exception {
        ...
        try {
            mapReader = new CsvMapReader(new FileReader("C:\\Users\\wsgpz\\IdeaProjects\\canvas\\src\\test\\java\\csv\\address.csv"), CsvPreference.STANDARD_PREFERENCE);
    ...
    private static void readWithCsvListReader() throws Exception {
        ...
        try {
            listReader = new CsvListReader(new FileReader("C:\\Users\\wsgpz\\IdeaProjects\\canvas\\src\\test\\java\\csv\\address.csv"), CsvPreference.STANDARD_PREFERENCE);
